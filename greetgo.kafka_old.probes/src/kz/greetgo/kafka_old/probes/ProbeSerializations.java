...
import kz.greetgo.kafka_old.probes.model.Box;
import kz.greetgo.kafka_old.probes.model.Client;
import kz.greetgo.kafka_old.probes.model.Header;
...
public class ProbeSerializations {
  ...
  public static void main(String[] args) throws Exception {
    ...
    for (Class<?> aClass : scanner.scanPackage("kz.greetgo.kafka_old.probes.model")) {
